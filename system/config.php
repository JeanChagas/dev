<?php
    ...
    define('DB_PASS', 'doscohab03');   
    define('DB_CHARSET', 'SET NAMES utf8');
    define("MYSQL_CONN_ERROR", "<center>Erro ao efetuar conexão com o bando de dados <b>".DB_HOST."</b>, entre em contato com o administrador do sistema. ");
